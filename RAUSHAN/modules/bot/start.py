...
async def hello(client: app, message):
    buttons = [
           [
            ...
            [
                InlineKeyboardButton("⚡Uᴘᴅᴀᴛᴇ 💕⚡", url="t.me/AD_Creation_Chatzone"),
            ],
            [
                InlineKeyboardButton("⚡S𝚄𝙿𝙿𝙾𝚁𝚃 💕⚡", url="t.me/Sanatani_Network"),
            ],
            ]
    reply_markup = InlineKeyboardMarkup(buttons)
    await client.send_photo(message.chat.id, ALIVE_PIC, caption=PHONE_NUMBER_TEXT, reply_markup=reply_markup)

# © By @Sanatani_Network Your motherfucker if uh Don't gives credits.
...
async def clone(bot: app, msg: Message):
    ...
    try:
        ...
        await msg.reply(f" ᴊᴀ ᴘᴇʟ ᴅᴇ sᴀʙᴋᴏ ᴀʙ ᴀᴋᴀsʜ ᴋᴏ ʙᴀᴀᴘ ʙᴏʟ ᴋᴇ ᴊᴀɴᴀ 🥵 {user.first_name} 💨.")
